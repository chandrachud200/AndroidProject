...
public class Chat_Handler extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        database1 = FirebaseDatabase.getInstance("https://quizzer-d6acf-default-rtdb.asia-southeast1.firebasedatabase.app/").getReference();
        FirebaseDatabase database = FirebaseDatabase.getInstance("https://quizzer-d6acf-default-rtdb.asia-southeast1.firebasedatabase.app/");
